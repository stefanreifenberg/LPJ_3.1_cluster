...
private:
	...
	// Output file names ...
	xtring file_cmass,file_anpp,file_agpp,file_fpc,file_aaet,file_dens,file_speciesdiam,file_lai,file_cflux,file_cpool,file_clitter,file_runoff;
	...
	// Output tables
	Table out_cmass, out_anpp, out_agpp, out_fpc, out_aaet, out_dens, out_speciesdiam, out_lai, out_cflux, out_cpool, out_clitter, out_firert, out_runoff, out_speciesheights;
